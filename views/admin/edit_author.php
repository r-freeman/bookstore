...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h2 class="sub-header">Edit author</h2>
            <form action="edit_author.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group <?= error('bio') ? ' has-error' : ''; ?>">
                    ...
                    <textarea class="form-control" name="bio" id="bio"><?= old('bio', $author->bio); ?></textarea>
                    <span class="help-block"><?= error('bio'); ?></span>
                </div>
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="featured"
                               id="featured" <?= old('featured', $author->featured) == 1 ? 'checked' : ''; ?>> Featured
                    </label>
                </div>
                <div class="form-group <?= error('photo') ? ' has-error' : ''; ?>">
                    <label class="control-label" for="photo">Photo <img width="50%" class="show" src="<?= $author->photo; ?>"
                                                                        alt="<?= $author->name; ?>">
                    </label>
