...
<head>
    ...
    <title>Bookstore | Create an account</title>
    ...
    <main>
        ...
        <form action="register.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control<?= error('password') ? ' form-control-error is-invalid' : ''; ?>"
            ...
            <div class="form-group">
                ...
                <input type="password"
                       class="form-control<?= error('password_confirmation') ? ' form-control-error is-invalid' : ''; ?>"
                       name="password_confirmation" id="password_confirmation">
                <div class="invalid-feedback d-block"><?= error('password_confirmation'); ?></div>
            </div>
